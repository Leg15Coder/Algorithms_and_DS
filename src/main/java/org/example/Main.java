...
public class Main {
  public static void main(String[] args) throws Exception {
    ...
    StringTokenizer quastionsInputTokenizer = new StringTokenizer(buffer.readLine());
    int quastions = Integer.parseInt(quastionsInputTokenizer.nextToken());

    for (int i = 0; i < quastions; ++i) {
      StringTokenizer line = new StringTokenizer(buffer.readLine());
